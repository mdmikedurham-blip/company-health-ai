            ...
            <>
              {lowConfidence ? (
                <p className="mt-3 rounded-lg border border-amber-500/20 bg-amber-500/5 px-3 py-2 text-xs text-amber-100/90">
                  Preliminary warning: valuation confidence is below 70%. Treat
                  this as a directional range, not a precise appraisal.
                </p>
              ) : null}
              <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-lg font-semibold text-emerald-300">
                    {formatUsdRange(ev.valueGapRange!)}
                  </p>
                </div>
                <div>
                  <p className="text-[10px] uppercase tracking-wider text-zinc-500">
